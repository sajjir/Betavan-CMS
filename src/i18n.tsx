...
export const translations = {
  en: {
    ...
    "seo_engine_checklist": "On-Page SEO Checklist",
    "seo_engine_internal_links": "Internal Linking Suggestions",
    "seo_engine_suggest_btn": "Analyze & Suggest Links",
    "seo_engine_suggesting": "Analyzing content...",
    "seo_engine_no_suggestions": "No internal link suggestions found. Try writing more text.",
    "seo_engine_write_more": "Write more content (title + some paragraph text) to unlock internal linking suggestions.",
    "seo_engine_copied_md": "Copied Markdown!",
    "seo_engine_copied_url": "Copied URL!",
    "seo_engine_copy_md": "Copy Markdown",
    "seo_engine_copy_url": "Copy URL",
    "seo_checklist_title_empty": "SEO title is missing.",
    "seo_checklist_title_perfect": "SEO title length is perfect",
    "seo_checklist_title_warn": "SEO title should be 50-60 characters",
    "seo_checklist_chars": "chars",
    "seo_checklist_desc_empty": "Meta description is missing.",
    "seo_checklist_desc_perfect": "Meta description length is perfect",
    "seo_checklist_desc_warn": "Meta description should be 120-160 characters",
    "seo_checklist_img_none": "No images in this post yet.",
    "seo_checklist_img_perfect": "At least one image has alt text",
    "seo_checklist_img_missing": "All images are missing alt text.",
    "seo_checklist_images": "images",
    "seo_checklist_cattag_none": "Assign a category and at least one tag.",
    "seo_checklist_cattag_perfect": "Category and tag(s) assigned.",
    "seo_checklist_tag_missing": "Category selected, but tag is missing.",
    "seo_checklist_cat_missing": "Tag selected, but category is missing.",
    "seo_checklist_slug_empty": "Slug is missing.",
    "seo_checklist_slug_perfect": "Slug format is perfect (lowercase and hyphenated).",
    "seo_checklist_slug_warn": "Slug should be lowercase and contain only alphanumeric chars and hyphens.",
    "seo_checklist_heading_missing": "No headings found in the post body.",
    "seo_checklist_heading_perfect": "At least one heading exists in the post body."
  },
  fa: {
    // Navbar / Toggle
    "lang_toggle_en": "EN",
    ...
    "seo_engine_checklist": "چک‌لیست سئوی داخلی",
    "seo_engine_internal_links": "پیشنهاد لینک‌سازی داخلی",
    "seo_engine_suggest_btn": "تجزیه و تحلیل و پیشنهاد لینک",
    "seo_engine_suggesting": "در حال بررسی محتوا...",
    "seo_engine_no_suggestions": "هیچ پیشنهادی برای لینک‌سازی داخلی پیدا نشد. متن بیشتری بنویسید.",
    "seo_engine_write_more": "برای دریافت پیشنهاد لینک‌سازی داخلی، متن بیشتری بنویسید (عنوان + حداقل یک پاراگراف).",
    "seo_engine_copied_md": "کد مارک‌داون کپی شد!",
    "seo_engine_copied_url": "لینک کپی شد!",
    "seo_engine_copy_md": "کپی مارک‌داون",
    "seo_engine_copy_url": "کپی آدرس",
    "seo_checklist_title_empty": "عنوان سئو وارد نشده است.",
    "seo_checklist_title_perfect": "طول عنوان سئو عالی است",
    "seo_checklist_title_warn": "عنوان سئو باید بین ۵۰ تا ۶۰ کاراکتر باشد",
    "seo_checklist_chars": "کاراکتر",
    "seo_checklist_desc_empty": "توضیحات متای سئو وارد نشده است.",
    "seo_checklist_desc_perfect": "طول توضیحات متای سئو عالی است",
    "seo_checklist_desc_warn": "توضیحات متای سئو باید بین ۱۲۰ تا ۱۶۰ کاراکتر باشد",
    "seo_checklist_img_none": "هیچ تصویری در این مطلب وجود ندارد.",
    "seo_checklist_img_perfect": "حداقل یک تصویر دارای متن جایگزین (Alt) است",
    "seo_checklist_img_missing": "تمامی تصاویر فاقد متن جایگزین (Alt) هستند.",
    "seo_checklist_images": "تصویر",
    "seo_checklist_cattag_none": "یک دسته‌بندی و حداقل یک برچسب انتخاب کنید.",
    "seo_checklist_cattag_perfect": "دسته‌بندی و برچسب(ها) تعیین شده‌اند.",
    "seo_checklist_tag_missing": "دسته‌بندی انتخاب شده، اما برچسب وارد نشده است.",
    "seo_checklist_cat_missing": "برچسب انتخاب شده، اما دسته‌بندی وارد نشده است.",
    "seo_checklist_slug_empty": "شناسه آدرس (اسلاگ) وارد نشده است.",
    "seo_checklist_slug_perfect": "فرمت اسلاگ صحیح است (حروف کوچک انگلیسی و خط تیره).",
    "seo_checklist_slug_warn": "اسلاگ باید فقط با حروف کوچک انگلیسی، اعداد و خط تیره نوشته شود.",
    "seo_checklist_heading_missing": "هیچ سربرگی (H1-H6) در بدنه پست یافت نشد.",
    "seo_checklist_heading_perfect": "حداقل یک سربرگ در بدنه پست وجود دارد."
  }
};
